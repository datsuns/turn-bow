...
class SheetService {
  ...
  static Future<void> updateFixedValue(String sheetName, Map<String, dynamic> data) async {
  ...
  static Future<void> updateYearlyData(String sheetName, Map<String, dynamic> data) async {
